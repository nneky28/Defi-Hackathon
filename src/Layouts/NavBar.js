  ...
  return (
    <>
      ...
      >
        ...
        <Link to="/"> {/* <Text fontSize="15px" p={2}>Discover</Text> */}</Link>
        {/* <Link to="/"> */}
        ...
        {home && (
          <>
            <Text as="button" onClick={onModalOpen} p={2} fontSize="15px">
              Sign Up
            </Text>
            <Text as="button" onClick={onModalOpen} p={2} fontSize="15px">
              Sign In
      ...
      <>
        ...
        >
          ...
          <ModalContent>
            ...
            <ModalBody p={"12px"}>
              <Center>
                <Heading fontSize="24px" w={"50%"}>
                  How would you
                </Heading>
              </Center>
              <Center>
                <Heading fontSize="23px" w={"50%"} ms={{ base: 0, md: 5 }}>
                  like to sign up
                </Heading>
              </Center>
              ...
              <Box p={5}>
                <Select
                  placeholder="Sign up as an investor or a start techup"
                  borderColor="purple"
              ...
              <Center>
                <Flex p={3} gap={10}>
                  <Text as="button" onClick={onModalClose}>
                    Cancel
                  </Text>
                  {selectedOption === "option1" ? (
                    <Link to="/SignUp">
                      <Button background="#8054DE" color="#ffff">
                        Continue
                      </Button>
                    </Link>
                  ) : (
