...
export default function FundedCard({title,description,icon,value,funds,ongoing,subtitle}) {
  return (
...
>
 ongoing
    ...
    <Flex  gap='3'direction={['column', 'row']}  paddingTop={3}>
    ...
    {
      ongoing &&
      <Flex  gap='150'direction={['column', 'row']}  paddingTop={3}>
